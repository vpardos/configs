...
**Output**: Give your honest assessment with relevant reasoning. Reference specific files and line numbers when relevant. State any assumptions clearly. Note any uncertainties.